<template>
      ...
      <main class="main">
        <div class="container container--theme">
          <div class="breadcrumbs">
            <NuxtLink to="/">Home</NuxtLink> &gt; AVIF to JPG Converter
          </div>
          <div class="page-container">
            <h1>Convert AVIF to JPG Online</h1>
            <p>Best AVIF to JPG converter. Convert AVIF to JPG online in the highest quality within seconds. Works on any web browser &amp; 100% free.</p>
            ...
            <div class="info-sections">
              <div class="section-block">
                ...
                <div class="feature-cards">
                  <div class="feature-card">
                    ...
                    <h3>Easy to Use</h3>
                    <p>Simply upload your AVIF files and click the convert button. You can also batch convert AVIF to JPG format.</p>
                  </div>
                  <div class="feature-card">
                    <div class="feature-icon">⭐</div> <!-- Placeholder for icon -->
                    <h3>High Quality Conversion</h3>
                    <p>Our web app transforms your AVIF images into high-quality JPG format, preserving image fidelity.</p>
                  </div>
                  <div class="feature-card">
                    <div class="feature-icon">🔒</div> <!-- Placeholder for icon -->
                    <h3>Free & Secure</h3>
                    <p>Our AVIF to JPG converter is free and works on any web browser. Files are protected with 256-bit SSL encryption and automatically delete after a few hours.</p>
                  </div>
                </div>
              </div>
              ...
              <div class="section-block">
                ...
                <p>JPG (or JPEG) is a commonly used method of lossy compression for digital images, particularly for those produced by digital photography. The degree of compression can be adjusted, allowing a selectable tradeoff between storage size and image quality. JPG is widely used for storing and transmitting photographic images on the web and in digital cameras due to its efficient compression, which significantly reduces file size while maintaining acceptable visual quality for most purposes.</p>
                <h3>How to open a JPG file?</h3>
                <p>JPG files are universally supported across all operating systems, web browsers, and image editing software. You can open JPG files with default image viewers on Windows (Photos), macOS (Preview), and Linux. All major web browsers (Chrome, Firefox, Edge, Safari) display JPG images natively. For editing, popular software like Adobe Photoshop, GIMP, Paint.NET, and many others provide full support for JPG files.</p>
              </div>
  ...
  // Convert a single AVIF file to JPG
  const convertAvifToJPG = async (fileItem) => {
    ...
    try {
      ...
      // Changed to 'image/jpeg' with quality parameter
      ...
      fileItem.downloadFileName = fileItem.name.replace(/\.avif$/i, '.jpg'); 
  ...
  const startConversion = async () => {
    ...
    for (const fileItem of files.value) {
      if (fileItem.status === 'pending' || fileItem.status === 'failed') {
        await convertAvifToJPG(fileItem); // Call the AVIF to JPG conversion function
      }
    }
  ...
  useHead({
    title: 'AVIF to JPG Converter - ImageConvert.me',
    meta: [
      { name: 'description', content: 'Best AVIF to JPG converter. Convert AVIF to JPG online in the highest quality within seconds. Works on any web browser & 100% free.' },
      { name: 'keywords', content: 'avif to jpg, convert avif, avif converter, jpg converter, free avif to jpg, online image converter' },
    ],
    ...
    script: [
    {
      ...
      },
      {
        ...
        children: JSON.stringify({
          ...
          "name": "AVIF to JPG Converter by ImageConvert.me",
          "description": "Convert AVIF images to JPG format online for free. Optimize file size for web and maintain good image quality with our easy-to-use converter.",
          "url": "https://www.imageconvert.me/avif-to-jpg",
