<template>
    <div class="image-converter-section">
      ...
      <div class="file-list-area" v-if="files.length > 0">
        ...
        <div class="file-item" v-for="(file, index) in files" :key="file.id">
          ...
          <div class="file-options">
            ...
            <!-- 仅在转换完成时显示下载按钮 -->
            <a v-if="file.status === 'completed' && file.downloadUrl" :href="file.downloadUrl" :download="file.downloadFileName" class="button primary download-button">
               Download
            ...
            <!-- 移除按钮 -->
            <span class="icon-button remove-button" @click="removeFile(index)"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-circle" viewBox="0 0 16 16"><path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/><path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z"/></svg></span>
          </div>
        </div>
        ...
        <div class="main-action-buttons">
            ...
            <button v-if="allFilesCompleted" @click="handleAddMoreFilesClick" class="button secondary convert-more-button">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-up-right" viewBox="0 0 16 16">
                  ...
                  <path fill-rule="evenodd" d="M16 .5a.5.5 0 0 0-.5-.5h-5a.5.5 0 0 0 0 1h3.146L4.354 9.146a.5.5 0 1 0 .708.708L15 1.707V4.5a.5.5 0 0 0 1 0v-5z"/>
                </svg>
            </button>
      ...
      <div class="footer-info" v-if="files.length > 0">
          Converted files are automatically deleted after 8 hours to protect your privacy. Please download files before they are deleted.
      </div>
